...
from app.api.handlers.product_handler import create_product, get_products_handler, get_product_by_id_handler, update_product_handler, delete_product_handler, update_availability_handler
...
async def update_product_availability(product_id: int, session: AsyncSessionDependency):
  return await update_availability_handler(product_id, session)
